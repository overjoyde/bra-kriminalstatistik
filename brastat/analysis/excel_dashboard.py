...
Usage:
    python scripts/build_excel_dashboard.py            # -> data/dashboard/Bra_trendbevakning_dashboard.xlsx
...
FILENAME = "Bra_trendbevakning_dashboard.xlsx"
