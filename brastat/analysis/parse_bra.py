...
Outputs (DataFrames) are consumed by excel_dashboard.py, html_dashboard.py and charts.py.
...
def root() -> str:
    """Datakatalog med raw/ (från fetch_tables.py). Styrs med BRA_DATA_DIR. Läses vid varje anrop."""
    return str(data_dir(create=False))
...
def main() -> None:
    """Skriv ut översikter av tolkad data (felsökning av Brås tabellformat)."""
    m = monthly()
